...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="my_imports.php" class="nav-link">
  ...
  <div class="register-logo">
    <center><b>Bienvenido a la aduana de Ecuador</b></center>
  </div>
              ...
              <div class="inner">
                <?php 
                  ...
                  if(isset($useractivo)){
                    ...
                    $sql_pro = mysqli_query($conexion, "SELECT count(id_import) FROM importacion WHERE importador='$iduser'");
                ...
                ?>
                <p>Mis importaciones</p>
              </div>
              <div class="icon">
                <i class="ion ion-bag"></i>
              </div>
              <a href="./my_imports.php" class="small-box-footer">Mas información<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
                      ...
                      if(isset($useractivo)){
                        ...
                        $sql= mysqli_query($conexion, "SELECT SUM(total_import) FROM importacion WHERE importador= $iduser");
                          while($consulta = mysqli_fetch_array($sql)){
                            ...
                            echo "<h3>"."$".number_format($consulta['SUM(total_import)'],2, ",", ".")."</h3>";

                          }     
                      }
                  ?>
                  
                  <p>Mi saldo de importacion</p>
                </div>
                <div class="icon">
                ...
                <div class="inner">
                  <?php 
                    ...
                    if(isset($useractivo)){
                      ...
                      $sql= mysqli_query($conexion, "SELECT SUM(cantidad) FROM canasta WHERE usuario= $iduser");
                        while($consulta = mysqli_fetch_array($sql)){
                  ...
                  ?>
                  <p>Productos en mi canasta</p>
                </div>
                <div class="icon">
                  <i class="fas fa-shopping-basket"></i>
                </div>
                <a href="#" class="small-box-footer">Mas información<i class="nav-icons fas fa-arrow-circle-right"></i></a>
              </div>
          </div>
        </div>
      </div>
