  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./import_decoracion.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Decoracion</p>
                </a>
              </li>
    ...
    <center><div class="register-box">
        ...
        <div class="card">
            ...
            <p class="login-box-msg">Agréga Decoraciones a tu canasta</p>

            <form action="" method="post">

                <div class="input-group mb-3">
                        <select class="form-control" name="pro" required="required">
                            <option disabled selected>Selecciona Decoracion</option>
                            <?php
                            include("conexionbd.php");
                                            
                            $SQL = mysqli_query($conexion, "SELECT * FROM productos pr inner join categoria ct
                            ON (pr.categoria=ct.id_cat) where ct.categoria='Decoracion' ");
                        ...
                        <?php
                          ...
                          include("conexionbd.php");
                            ...
                            if(isset($usuarioactivo)){
                                ...
                                ON (ca.producto=ps.id_producto) INNER JOIN usuario ur ON (ca.usuario=ur.id_usuario) where (username='$usuarioactivo' or email='$useractivo') and ca.categoria_prod=3 ORDER BY fecha DESC");
