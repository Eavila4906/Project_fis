      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
              ...
              <li class="nav-item">
                <a href="./reporte_canastas.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Canastas</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
        ...
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Reporte de los productos en canasta</h1>
            </div>
        ...
        <div class="card">
            ...
            <h3 class="card-title">Canasta</h3>
            ...
            <table class="table table-striped projects">
                ...
                <tbody>
                    ...
                    $usuario = $_SESSION["USUARIO"];
                        if(isset($usuario)){
                        $sql_pro = mysqli_query($conexion, "SELECT * FROM canasta ct INNER JOIN usuario ur on (ct.usuario=ur.id_usuario)
                        INNER JOIN productos pr on (ct.producto=pr.id_producto) INNER JOIN categoria ca ON (ct.categoria_prod=ca.id_cat) ORDER BY fecha DESC");
                        ...
                        ?>
                            ...
                            <td>
                                <a>
                                <?php echo $consulta['categoria']; ?> 
                                </a>
                            </td>
                                    
                            <td class="project-state">
                                <span class="badge badge-success">$<?php echo number_format($consulta['subtotal'],2, ",", "."); ?></span>
                            </td>
