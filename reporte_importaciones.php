      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
              ...
              <li class="nav-item">
                <a href="./reporte_importaciones.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Importaciones</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Reporte de Importacion de productos</h1>
          </div>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Importaciones</h3>
          ...
          <table class="table table-striped projects">
              ...
              <tbody>
                <?php
                  ...
                  $usuario = $_SESSION["USUARIO"];
                    if(isset($usuario)){
                      $sql_pro = mysqli_query($conexion, "SELECT * FROM importacion im INNER JOIN usuario ur on (im.importador=ur.id_usuario)
                      INNER JOIN productos pr on (im.producto=pr.id_producto) ORDER BY fecha_import DESC");
                      ...
                      ?>
                        <tr>
                          <td>
                            ...
                            <br/>
                            <small>
                              Importó el <?php echo $consulta['fecha_import']; ?> 
                            </small>
                          </td>
