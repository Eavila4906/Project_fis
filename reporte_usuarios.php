      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./reporte_usuarios.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Usuarios</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Reportes de Administradores y Usuarios registrados en el sistema</h1>
          </div>
          <div class="col-sm-6">
          ...
          <table class="table table-striped projects">
              ...
              <tbody>
                <?php
                    ...
                    $usuario = $_SESSION["USUARIO"];
                      if(isset($usuario)){
                        $sql_pro = mysqli_query($conexion, "SELECT * FROM usuario us INNER JOIN rol rl
                        ON (us.rol=rl.id_rol) WHERE rl.rol='ADMINISTRADOR' ORDER BY fecha_registro ASC");
                        while($consulta = mysqli_fetch_array($sql_pro)){

                        ?>
                          <tr>
                            <td>
                              <?php echo $consulta['id_usuario']; ?> 
                            </td>
                            ...
                            <br/>
                            <small>
                              Regitrado el <?php echo $consulta['fecha_registro']; ?>
                            </small>
                            </td>
                            ...
                            <td class="project-state">
                              <span class="badge badge-success"><?php echo $consulta['rol']; ?></span>
                            </td>

                            <td class="project-state">
                              <span class="badge badge-success"><?php echo $consulta['estado']; ?></span>
                            </td>
              ...
              <tbody>
                  <?php
                    ...
                    $usuario = $_SESSION["USUARIO"];
                      if(isset($usuario)){
                        $sql_pro = mysqli_query($conexion, "SELECT * FROM usuario us INNER JOIN rol rl
                        ON (us.rol=rl.id_rol) WHERE rl.rol='USUARIO' ORDER BY fecha_registro ASC");
                        while($consulta = mysqli_fetch_array($sql_pro)){
