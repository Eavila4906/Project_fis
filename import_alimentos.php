  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <center><div class="register-box">
        ...
        <div class="card">
            ...
            <p class="login-box-msg">Agréga alimentos a tu canasta</p>
            ...
            <form action="" method="post">
                ...
                <div class="input-group mb-3">
                        <select class="form-control" name="pro" required="required">
                            ...
                            ON (pr.categoria=ct.id_cat) where ct.categoria='Alimento' ");
                        ...
                        <?php
                          ...
                          include("conexionbd.php");
                            ...
                            if(isset($usuarioactivo)){
                              ...
                              ON (ca.producto=ps.id_producto) INNER JOIN usuario ur ON (ca.usuario=ur.id_usuario) where (username='$usuarioactivo' or email='$useractivo') and ca.categoria_prod=1 ORDER BY fecha DESC");
