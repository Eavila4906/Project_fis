        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./registrar_producto.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Productos</p>
                </a>
              </li>
    ...
    <div class="card-body register-card-body">
      ...
      <form action="" method="post">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="namepro" placeholder="Nombre del producto" required="required">
          <div class="input-group-append">
                ...
                <?php
                  ...
                  $SQL = mysqli_query($conexion, "SELECT * FROM categoria");
                    while ($row = mysqli_fetch_array($SQL)) {
                      ?>
                        <option value="<?php echo $row['id_cat']?>"><?php echo utf8_encode($row['categoria'])?></option>
                      <?php
                    }
                ?>
            </select>
      ...
      <?php
        ...
        if(isset($_POST['btn_reg'])){
          ...
          $validar_producto = mysqli_query($conexion, "SELECT * FROM productos 
          WHERE producto= '$namepro'");
          if(mysqli_num_rows($validar_producto) > 0){
            echo '<script>
              alert("Este producto ya se encuentra registrado en el sistema");
              window.history.go(-1);
            </script>';
            exit;
          }
                                            
          $insertar = "INSERT INTO productos (producto, peso, precio, categoria)
          VALUES ('$namepro','$peso','$precio','$categoria')";
